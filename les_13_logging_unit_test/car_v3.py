...
class Car():
    ...
    _brands = ['Peugeot', 'Opel', 'McLaren']
    _colors = [CarColor('red', '#09384'), CarColor('grey', '#44444')]
    ...
    def to_json(self):
        return dict(brand=self.__brandtype, model=self.model, color=self.__colortype, price=self.price)
